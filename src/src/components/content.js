...
function Content() {
    ...
    return(
      ...
      name: username
        ...
        <h1 className="text-2xl mx-auto ml-60 w-50 align-center"><span className="p-2 bg-gray-900 font-mono text-white">Ask fellow developers questions and engage with the community.</span></h1>
